...
class Kinematics_sim(Node):
    def __init__(self):
        ...
        self.publisher = self.create_publisher(
            PoseStamped,
            'mini/end_effector_pose_sim', 10)

        # The lengths of the mini robot
        self.l0 = 0.043 + 0.084 # 0.127 m
        self.l1 = 0.2
        self.l2 = 0.2
    ...
    def joint_state_callback(self, msg: JointState):
        ...
        if len(msg.position) < 2:
            self.get_logger().warn('Error  /joint_states !')
            return
        ...
        # The kinematic
        x = self.l0 + self.l1 * math.cos(q0) + self.l2 * math.cos(q0 + q1)
