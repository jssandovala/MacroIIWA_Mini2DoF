...
"""
  ...
  system has to follow in real time for the real robot.  
...
class TrajectoryGeneratorNode(Node):
    def __init__(self):
        ...
        self.position_sub = self.create_subscription(
            ...
            self.end_effector_pose_callback, 10)
        ...
        self.dx = 0.08  # cm step in x
        self.dy = 0.08  # cm step in y
    ...
    def update_trajectory(self):
        ...
        while rclpy.ok() and self.current_target_index < len(self.target_positions):
            ...
            if abs(error_x) < 0.001 and abs(error_y) < 0.001 and result == Result.Finished :  # 1 mm tolerance
                ...
                time.sleep(1)  # Pause for a second before moviulng to the next target
