...
def generate_launch_description():
    ...
    iiwa_vel_ = Node(
        package='kuka_mini',
        executable='iiwa_vel_telop_sim.py',
        name='iiwa_vel_telop_sim',
        output='screen',
    )

    mini_effort_tm_sim = Node(
        package='kuka_mini',
        executable='mini_effort_tm_sim',
        name='mini_effort_tm_sim',
        output='screen',
    )

    iiwa_FK_ = Node(
        package='kuka_mini',
        executable='iiwa_FK_tool_sim.py',
    ...
    interactive_marker_ = Node(
        package='kuka_mini',
        executable='interactive_marker_mini_decoupled.py',
