...
def generate_launch_description():
    ...
    mini_effort_traj = Node(
        package='kuka_mini',
        executable='mini_effort_traj', 
        name='mini_effort_traj',
        output='screen',
    )
    ...
    mini_ee_visual_ = Node(
        package='kuka_mini',
        executable='mini_ee_visual.py',
        name='mini_ee_visual',
        output='screen',
    )

    mini_kuka_transform_for_traj_ = Node(
        package='kuka_mini',
        executable='mini_kuka_transform_for_traj',
        name='mini_kuka_transform_for_traj',
        output='screen',
    )
